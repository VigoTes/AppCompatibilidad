...
class VentaController extends Controller
{
  ...
  public function ListarVentas(Request $request){
    ...
    $listaVentas = $listaVentas->orderBy('codVenta','desc')->paginate($this::PAGINATION);
  ...
  public function DescargarVentas(Request $request){
    ...
    $listaVentas = $listaVentas->orderBy('codVenta','desc')->get();
 
    
    
    return view('VentaCaja.DescargarVentasCaja',compact('listaVentas','filtros_usados'));
  ...
  public function GuardarVenta(Request $request){
    try {
      ...
      $venta->save();
      $venta->codigo = self::rellernarCerosIzq($venta->getId(),6);
